...
class BatchRowMeta:
    """ Metadata class for BatchRow data objects."""
    def __init__(self):
    ...
    def get_column_by_index(self, index: int) -> Column:
        raise NotImplementedError("get_column_by_index is implemented in C++ extension.")
    
    def get_column_by_name(self, name: str) -> Column:
        raise NotImplementedError("get_column_by_name is implemented in C++ extension.")
